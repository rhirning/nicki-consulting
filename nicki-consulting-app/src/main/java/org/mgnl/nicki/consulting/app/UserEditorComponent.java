...
public class UserEditorComponent extends CustomComponent implements Serializable, View {
	...
	public UserEditorComponent(NickiApplication nickiApplication) {
...
//		editor.setClassEditor(Script.class, scriptViewer);
		...
		editor.addAction(new ExportTreeAction(getNickiContext(), LdapPerson.class, I18n.getText(getI18nBase() + ".action.export"), getI18nBase()));
		editor.initActions();
